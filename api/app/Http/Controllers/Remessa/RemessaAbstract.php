...
abstract class RemessaAbstract
{
    ...
    public function __construct($banco, $layout, $data)
    {
        ...
        self::$banco = $banco;
        self::$layout = $layout;
        $class = '\App\\Http\Controllers\resources\\B' . self::$banco . '\remessa\\' . self::$layout . '\Registro0';
        self::$entryData = $data;
    ...
    public function inserirDetalhe($data)
    {
        ...
        $class = '\App\Http\Controllers\resources\\B' . self::$banco . '\remessa\\' . self::$layout . '\Registro1';
    ...
    public function getText()
    {
        ...
        $class = '\App\Http\Controllers\resources\\B' . self::$banco . '\remessa\\' . self::$layout . '\Registro9';
