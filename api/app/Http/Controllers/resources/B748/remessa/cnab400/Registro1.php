...
namespace App\Http\Controllers\resources\B748\remessa\cnab400;

use App\Http\Controllers\Registro\RegistroRemAbstract;
use App\Http\Controllers\Remessa\RemessaAbstract;
use App\Http\Controllers\resources\generico\remessa\cnab400\Generico1;
...
class Registro1 extends Generico1 {
    ...
    public function inserirMensagem($data) {
        if (!empty($data['mensagem'])) {
            $class = 'App\Http\Controllers\resources\\B' . RemessaAbstract::$banco . '\remessa\\' . RemessaAbstract::$layout . '\Registro2';
